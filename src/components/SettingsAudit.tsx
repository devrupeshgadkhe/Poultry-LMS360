                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  ...
                  <div className="flex gap-2 shrink-0">
                    <button
                      ...
                      className="px-2.5 py-1 bg-slate-100 text-slate-600 hover:bg-slate-200 rounded-lg text-[10px] font-mono font-bold"
                    >
                      CHOOSE ALL
                    </button>
                    <button
                      ...
                      className="px-2.5 py-1 bg-rose-50 text-rose-600 hover:bg-rose-105 rounded-lg text-[10px] font-mono font-bold"
                    >
                      REVOKE ALL
                    </button>
                  </div>
